...
commands = ["IPC", "MWS", "latency", "overlap"]
...
def main():
    ...
    if command == "IPC":
        ...
        results, aggRes = computeTraceError(dirs, np, getTracename, opts.relativeErrors, opts.quiet, "Alone Overlap", "Shared Overlap", False, True) 
    else:
